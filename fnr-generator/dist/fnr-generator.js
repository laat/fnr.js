...
var _fnr = require('fnr.js');

function Generator(dato) {
  ...
  var inkLopenr = function inkLopenr() {
  ...
  var harFlereLopenr = function harFlereLopenr() {
    var aar = dato.getFullYear();
  ...
  var generer = function generer() {
    var fnr = '';
    while (harFlereLopenr() && fnr === '') {
      var fnrStart = fodselsnummerFormatDato(dato) + padNumber(inkLopenr(), 2);

      var k1 = (0, _fnr.beregnKontrollsiffer1)(fnrStart);
      if (k1 === 10) continue;
      fnrStart = fnrStart + k1.toString();

      var k2 = (0, _fnr.beregnKontrollsiffer2)(fnrStart);
      if (k2 === 10) continue;
  ...
  var harNeste = function harNeste() {
